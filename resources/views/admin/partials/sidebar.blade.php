<div>
    <ul class="d-flex flex-column gap-4 p-0">
        ...
        <li class="btn-sidebar text-sm-start">
            <a href="{{route('admin.items.create', Auth::user()->slug)}}">
