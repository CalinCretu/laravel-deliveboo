        ...
        <div class="wrapper">
            ...
            <div class="form-container">
                ...
                <form method="POST" action="{{ route('register') }}" enctype="multipart/form-data">
                    ...
                    <div class="input">
                        <input id="vat_id" type="text" class="form-control @error('address') is-invalid @enderror"
                            name="vat_id" value="{{ old('vat_id') }}" required autocomplete="vat_id" placeholder="&nbsp">
                        @error('vat_id')
                            <span class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
                            </span>
